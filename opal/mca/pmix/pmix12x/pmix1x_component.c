...
/*
 * Public string showing the pmix pmix12x component version number
 */
const char *opal_pmix_pmix12x_component_version_string =
    "OPAL pmix1.2.3 MCA component version " OPAL_VERSION;
...
mca_pmix_pmix12x_component_t mca_pmix_pmix12x_component = {
    {
...
static int external_open(void)
{
    OBJ_CONSTRUCT(&mca_pmix_pmix12x_component.jobids, opal_list_t);
    return OPAL_SUCCESS;
}

static int external_close(void)
{
    OPAL_LIST_DESTRUCT(&mca_pmix_pmix12x_component.jobids);
    return OPAL_SUCCESS;
}
...
static int external_component_query(mca_base_module_t **module, int *priority)
{
    ...
    *module = (mca_base_module_t *)&opal_pmix_pmix12x_module;
    return OPAL_SUCCESS;
}
