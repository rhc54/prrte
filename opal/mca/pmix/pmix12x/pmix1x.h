...
#ifndef MCA_PMIX_PMIX12X_H
#define MCA_PMIX_PMIX12X_H
...
typedef struct {
  ...
  opal_list_t jobids;
  bool native_launch;
} mca_pmix_pmix12x_component_t;

OPAL_DECLSPEC extern mca_pmix_pmix12x_component_t mca_pmix_pmix12x_component;

OPAL_DECLSPEC extern const opal_pmix_base_module_t opal_pmix_pmix12x_module;
