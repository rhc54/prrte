...
prte_grpcomm_base_module_t prte_grpcomm_direct_module = {
    ...
    .xcast = xcast,
    .allgather = allgather,
    .grp_construct = prte_grpcomm_direct_grp_construct
};
...
static int init(void)
{
    ...
    PRTE_RML_RECV(PRTE_NAME_WILDCARD, PRTE_RML_TAG_GRP_CONSTRUCT_DIRECT,
...
static void finalize(void)
{
    ...
    PRTE_RML_CANCEL(PRTE_NAME_WILDCARD, PRTE_RML_TAG_ALLGATHER_DIRECT);
    PRTE_RML_CANCEL(PRTE_NAME_WILDCARD, PRTE_RML_TAG_COLL_RELEASE);
    PRTE_RML_CANCEL(PRTE_NAME_WILDCARD, PRTE_RML_TAG_GRP_CONSTRUCT_DIRECT);
